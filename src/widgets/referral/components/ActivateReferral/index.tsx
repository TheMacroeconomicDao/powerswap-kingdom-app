    ...
    return(
        <>
            ...
            <motion.div
                ...
                className='z-50 absolute top-[30%] w-[90%] min-w-[280px] max-w-[350px] h-[300px] flex flex-col justify-around items-center bg-black border border-[#fff] border-y-2 p-7'>
